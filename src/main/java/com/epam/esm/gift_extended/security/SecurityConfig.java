...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic()
                ...
                .antMatchers(HttpMethod.GET,"/api/tags/**").hasAuthority("USER")
                .antMatchers(HttpMethod.GET,"/api/users/**").hasAuthority("USER")
                .antMatchers(HttpMethod.GET,"/api/gift-certs/**").hasAuthority("USER")
                .antMatchers(HttpMethod.POST,"/api/user/*/certs").hasAuthority("USER")
                .antMatchers(HttpMethod.POST,"/api/tags/**").hasAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE,"/api/tags/**").hasAuthority("ADMIN")
