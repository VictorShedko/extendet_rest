...
INSERT INTO user (user_id, name) VALUES (25, 'Vasya');

INSERT INTO certificate (id, creation_time, description, duration, name, price, update_time, user_id) VALUES (2, null, 'certificate holder can get sale', 50, 'parfume by gucci', 25, null, 25);
